...
\toolsname{Racon} was polishing tools create on top of \miniasm pipeline to perform a polishing of contig, we can cite \toolsname{CONSENT} was a correction and polishing tools.
