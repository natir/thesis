...
\rc{j'en suis ici de la relecture (et en fait, corrections) de 1.2}
...
Find overlap between reads are generaly the bootleneck of many assembly algorithm. \pim{sa n'a peut-être pas sa place ici}
