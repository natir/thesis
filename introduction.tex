...
\pim{présenté le découpage en kmer}
...
\pim{preséenté les défaut, problème des réptpétino plus grand que k choix du k zone peut couverte}
...
\pim{rajouté des citations et des fais ou les long reads on amélioré les génomes }
...
\pim{nuancé le propos précédant}
...
\pim{les indles bloc la detection de proteine voir http://www.opiniomics.org/a-simple-test-for-uncorrected-insertions-and-deletions-indels-in-bacterial-genomes/}
