...
\jsv{To perform overlapping many tools were designed but still plenty of room for improvement exist on real read dataset for example. Si tu dis cela on peut croire que tu vas presenter un nouvel overlapper} 
