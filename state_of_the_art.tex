...
We can see assembly tools can be split in step. Between each assembly tools we can found some similarity, between step. But we can observe that in the most recent assemblers (see section \ref{section:sota:wtdbg} and \ref{sec:sota:new_assembly_tools}), the interdependence between each step of the assembly is more and more important.
